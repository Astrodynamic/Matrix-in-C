...
START_TEST(create_1) {
  matrix_t m1;
  int check = castom_create_matrix(2, 4, &m1);
  int check_origin = 0;
  castom_remove_matrix(&m1);
...
START_TEST(create_4) {
  matrix_t m1;
  int check = castom_create_matrix(0, 15, &m1);
  int check_origin = 1;
  castom_remove_matrix(&m1);
  ck_assert_int_eq(check, check_origin);
}
...
START_TEST(create_5) {
  matrix_t m1;
  int check = castom_create_matrix(1, 1, &m1);
  int check_origin = 0;
  castom_remove_matrix(&m1);
  ck_assert_int_eq(check, check_origin);
}
...
START_TEST(eq_1) {
  ...
  matrix_t m2;
  int check_origin = 0;
  int check_1 = castom_create_matrix(3, 3, &m1);
  int check_2 = castom_create_matrix(3, 3, &m2);
  m1.matrix[0][0] = 0.0;
  m1.matrix[0][1] = 1.0;
  m1.matrix[0][2] = 2.0;
  m1.matrix[1][0] = 3.0;
  ...
  m2.matrix[2][1] = 7.0;
  m2.matrix[2][2] = 8.0;
  int result = castom_eq_matrix(&m1, &m2);
  int result_origin = SUCCESS;
  castom_remove_matrix(&m1);
  castom_remove_matrix(&m2);
...
START_TEST(castom_eq_matrix_1) {
  matrix_t A;
  castom_create_matrix(2, 2, &A);
  A.matrix[0][0] = 3.3333335;
  A.matrix[0][1] = -5;
  A.matrix[1][0] = 6;
  A.matrix[1][1] = -3;
  matrix_t B;
  castom_create_matrix(2, 2, &B);
  B.matrix[0][0] = 3.33333356;
  B.matrix[0][1] = -5;
  B.matrix[1][0] = 6;
  B.matrix[1][1] = -3;
  int result = castom_eq_matrix(&A, &B);
...
START_TEST(castom_eq_matrix_6) {
  matrix_t A;
  castom_create_matrix(1, 1, &A);
  A.matrix[0][0] = 1;
  matrix_t B;
  castom_create_matrix(1, 1, &B);
  B.matrix[0][0] = 1;
  int result = castom_eq_matrix(&A, &B);
  ck_assert_int_eq(result, 1);
  castom_remove_matrix(&A);
...
START_TEST(sum_1) {
  ...
  int check_1 = castom_create_matrix(3, 3, &m1);
  int check_2 = castom_create_matrix(3, 3, &m2);
  int check_3 = castom_create_matrix(3, 3, &origin);
  m1.matrix[0][0] = 0.1;
  m1.matrix[0][1] = 0.2;
  m1.matrix[0][2] = 0.3;
  m1.matrix[1][0] = 0.4;
  ...
  int result = castom_sum_matrix(&m1, &m2, &r);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_2, check_origin);
  ...
  castom_remove_matrix(&m1);
  castom_remove_matrix(&m2);
  castom_remove_matrix(&r);
  castom_remove_matrix(&origin);
}
END_TEST
...
START_TEST(castom_sum_matrix_1) {
  matrix_t result, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &B);
  A.matrix[0][0] = 1;
  ...
  B.matrix[1][0] = 3;
  B.matrix[1][1] = 3;
  int check = castom_sum_matrix(&A, &B, &result);
  int check_origin = 0;
  ck_assert_int_eq(check, check_origin);
  ...
  castom_remove_matrix(&A);
  castom_remove_matrix(&B);
  castom_remove_matrix(&result);
}
END_TEST

START_TEST(castom_sum_matrix_2) {
  matrix_t result, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &B);
  A.matrix[0][0] = 0;
...
START_TEST(castom_sum_matrix_3) {
  matrix_t result, B, A;
  castom_create_matrix(1, 2, &A);
  castom_create_matrix(2, 2, &B);
  A.matrix[0][0] = 1;
  A.matrix[0][1] = 1;
  B.matrix[0][0] = 3;
...
START_TEST(castom_sum_matrix_4) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(4, 4, &A);
  castom_create_matrix(4, 4, &B);
  castom_create_matrix(4, 4, &res_origin);
  A.matrix[0][0] = 2;
  A.matrix[0][1] = 5;
  A.matrix[0][2] = 7;
  A.matrix[0][3] = -4;
  ...
  castom_remove_matrix(&B);
  castom_remove_matrix(&result);
  castom_remove_matrix(&res_origin);
}
END_TEST

START_TEST(castom_sum_matrix_5) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &B);
  castom_create_matrix(2, 2, &res_origin);
...
START_TEST(castom_sum_matrix_7) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(5, 5, &A);
  castom_create_matrix(5, 5, &B);
  castom_create_matrix(5, 5, &res_origin);
  for (int i = 0; i < A.rows; i++) {
...
START_TEST(castom_sum_matrix_8) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(5, 4, &A);
  castom_create_matrix(5, 4, &B);
  castom_create_matrix(5, 4, &res_origin);
  for (int i = 0; i < A.rows; i++) {
    for (int j = 0; j < A.columns; j++) {
      A.matrix[i][j] = i;
...
START_TEST(castom_sum_matrix_9) {
  matrix_t result, B, A;
  castom_create_matrix(-5, 5, &A);
  castom_create_matrix(5, 4, &B);
  int check = castom_sum_matrix(&A, &B, &result);
...
START_TEST(sub_1) {
  ...
  origin.matrix[2][1] = -7.2;
  origin.matrix[2][2] = -8.1;
  int result = castom_sub_matrix(&m1, &m2, &r);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_2, check_origin);
  ck_assert_int_eq(check_3, check_origin);
  ck_assert_int_eq(result, check_origin);
...
START_TEST(sub_4) {
  ...
  origin.matrix[2][1] = 0.8;
  origin.matrix[2][2] = 0.9;
  int result = castom_sub_matrix(&m2, &m1, &r);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_2, check_origin);
  ck_assert_int_eq(check_3, check_origin);
  ck_assert_int_eq(result, check_origin);
...
START_TEST(castom_sub_matrix_1) {
  matrix_t result, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &B);
  A.matrix[0][0] = 1;
  ...
  B.matrix[1][0] = 3;
  B.matrix[1][1] = 3;
  int check = castom_sub_matrix(&A, &B, &result);
  int check_origin = 0;
  ck_assert_int_eq(check, check_origin);
  for (int i = 0; i < A.rows; i++) {
    for (int j = 0; j < B.columns; j++) {
...
START_TEST(castom_sub_matrix_2) {
  matrix_t result, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &B);
  A.matrix[0][0] = 0;
...
START_TEST(castom_sub_matrix_3) {
  matrix_t result, B, A;
  castom_create_matrix(1, 2, &A);
  castom_create_matrix(2, 2, &B);
  A.matrix[0][0] = 1;
...
START_TEST(castom_sub_matrix_9) {
  matrix_t result, B, A;
  castom_create_matrix(-2, 2, &A);
  castom_create_matrix(2, 2, &B);
  int check = castom_sub_matrix(&A, &B, &result);
...
START_TEST(castom_sub_matrix_10) {
  matrix_t result, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(-2, 2, &B);
  int check = castom_sub_matrix(&A, &B, &result);
...
START_TEST(castom_sub_matrix_4) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(4, 4, &A);
  castom_create_matrix(4, 4, &B);
  castom_create_matrix(4, 4, &res_origin);
...
START_TEST(castom_sub_matrix_5) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &B);
  castom_create_matrix(2, 2, &res_origin);
...
START_TEST(castom_sub_matrix_7) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(5, 5, &A);
  castom_create_matrix(5, 5, &B);
  castom_create_matrix(5, 5, &res_origin);
...
START_TEST(castom_sub_matrix_8) {
  matrix_t result, res_origin, B, A;
  castom_create_matrix(5, 4, &A);
  castom_create_matrix(5, 4, &B);
  castom_create_matrix(5, 4, &res_origin);
...
START_TEST(mul_num_1) {
  ...
  int check_origin = 0;
  int check_1 = castom_create_matrix(3, 3, &m1);
  int check_2 = castom_create_matrix(3, 3, &origin);
  m1.matrix[0][0] = 0.1;
  m1.matrix[0][1] = 0.2;
  m1.matrix[0][2] = 0.3;
  m1.matrix[1][0] = 0.4;
  ...
  int result = castom_mult_number(&m1, num, &r);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_2, check_origin);
  ck_assert_int_eq(result, check_origin);
  for (int i = 0; i < r.rows; i++) {
...
START_TEST(castom_mult_number_1) {
  matrix_t A, result, res_origin;
  double num = 2.0;
  int check_origin = 0;
  int check_1 = castom_create_matrix(5, 4, &A);
  int check_3 = castom_create_matrix(5, 4, &res_origin);
  A.matrix[0][0] = 2;
  A.matrix[0][1] = 5;
  A.matrix[0][2] = 7;
  A.matrix[0][3] = -4;
  ...
  int check = castom_mult_number(&A, num, &result);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_3, check_origin);
  ck_assert_int_eq(check, check_origin);
  for (int i = 0; i < res_origin.rows; i++) {
...
START_TEST(castom_mult_number_2) {
  matrix_t A, result, res_origin;
  double num = 4.25;
  int check_origin = 0;
  int check_1 = castom_create_matrix(5, 4, &A);
...
START_TEST(castom_mult_number_3) {
  matrix_t A, result, res_origin;
  double num = 4.25;
  int check_origin = 1;
  castom_create_matrix(-5, 4, &A);
...
START_TEST(transpose_1) {
  ...
  matrix_t origin;
  int check_origin = 0;
  int check_1 = castom_create_matrix(3, 2, &m1);
  int check_2 = castom_create_matrix(2, 3, &origin);
  m1.matrix[0][0] = 1;
  m1.matrix[0][1] = 4;
  m1.matrix[1][0] = 2;
  m1.matrix[1][1] = 5;
  ...
  origin.matrix[1][1] = 5;
  origin.matrix[1][2] = 6;
  int result = castom_transpose(&m1, &r);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_2, check_origin);
  ck_assert_int_eq(result, check_origin);
  for (int i = 0; i < r.rows; i++) {
...
START_TEST(transpose_3) {
  ...
  matrix_t origin;
  int check_origin = 0;
  int check_1 = castom_create_matrix(1, 1, &m1);
  int check_2 = castom_create_matrix(1, 1, &origin);
  m1.matrix[0][0] = 1.1;
  origin.matrix[0][0] = 1.1;
  int result = castom_transpose(&m1, &r);
  ck_assert_int_eq(check_1, check_origin);
...
START_TEST(castom_transpose_4) {
  matrix_t A, result, result_origin;
  castom_create_matrix(5, 4, &A);
  castom_create_matrix(4, 5, &result_origin);
  A.matrix[0][0] = 2;
  A.matrix[0][1] = 5;
  A.matrix[0][2] = 7;
  A.matrix[0][3] = -4;
  ...
  castom_remove_matrix(&A);
  castom_remove_matrix(&result);
  castom_remove_matrix(&result_origin);
}
END_TEST

START_TEST(castom_transpose_5) {
  matrix_t A, result, res_origin;
  castom_create_matrix(4, 7, &A);
  castom_create_matrix(7, 4, &res_origin);
  for (int i = 0; i < A.rows; i++) {
    for (int j = 0; j < A.columns; j++) {
      A.matrix[i][j] = i;
    }
...
START_TEST(castom_transpose_6) {
  matrix_t A, result;
  castom_create_matrix(4, -7, &A);
  int check = castom_transpose(&A, &result);
  int check_origin = 1;
...
START_TEST(castom_mult_matrix_1) {
  matrix_t A, B, result, res_origin;
  int check_origin = 0;
  int check_1 = castom_create_matrix(5, 4, &A);
  int check_2 = castom_create_matrix(4, 4, &B);
  int check_4 = castom_create_matrix(5, 4, &res_origin);
  A.matrix[0][0] = 2;
  A.matrix[0][1] = 5;
  A.matrix[0][2] = 7;
  A.matrix[0][3] = -4;
  ...
  int check = castom_mult_matrix(&A, &B, &result);
  ck_assert_int_eq(check_1, check_origin);
  ck_assert_int_eq(check_2, check_origin);
...
START_TEST(castom_mult_matrix_2) {
  matrix_t A, B, result, res_origin;
  int check_origin = 0;
  int check_1 = castom_create_matrix(2, 2, &A);
  int check_2 = castom_create_matrix(2, 4, &B);
  int check_4 = castom_create_matrix(2, 4, &res_origin);
  A.matrix[0][0] = 2.987654;
  A.matrix[0][1] = -5.3456;
  A.matrix[1][0] = 6.23;
  A.matrix[1][1] = -3.9292;
...
START_TEST(castom_mult_matrix_3) {
  matrix_t A, B, result, res_origin;
  int check_origin = 0;
  int check_1 = castom_create_matrix(3, 3, &A);
  int check_2 = castom_create_matrix(3, 3, &B);
  int check_4 = castom_create_matrix(3, 3, &res_origin);
  A.matrix[0][0] = 0;
  A.matrix[0][1] = 9;
  A.matrix[0][2] = 1;
  A.matrix[1][0] = 1;
...
START_TEST(castom_mult_matrix_4) {
  matrix_t A, B, result;
  int check_origin = 2;
  castom_create_matrix(2, 3, &A);
  castom_create_matrix(4, 2, &B);
  int check = castom_mult_matrix(&A, &B, &result);
  ck_assert_int_eq(check, check_origin);
  castom_remove_matrix(&A);
  castom_remove_matrix(&B);
...
START_TEST(castom_mult_matrix_5) {
  matrix_t A, B, result;
  int check_origin = 0;
  castom_create_matrix(2, 3, &A);
  castom_create_matrix(3, 12, &B);
  for (int i = 0; i < B.rows; i++) {
    for (int j = 0; j < B.columns; j++) {
      B.matrix[i][j] = i + j;
    }
...
START_TEST(castom_mult_matrix_6) {
  matrix_t A, B, result;
  int check_origin = 1;
  castom_create_matrix(-12, 3, &A);
  castom_create_matrix(3, 12, &B);
  int check = castom_mult_matrix(&A, &B, &result);
  ck_assert_int_eq(check, check_origin);
  castom_remove_matrix(&B);
...
START_TEST(castom_determinant_1) {
  matrix_t A;
  double result;
  ...
  A.matrix[2][1] = 3;
  A.matrix[2][2] = 3;
  int check = castom_determinant(&A, &result);
  int check_origin = 0;
...
START_TEST(castom_determinant_2) {
  matrix_t A;
  double result;
  castom_create_matrix(4, 4, &A);
  A.matrix[0][0] = 1;
...
START_TEST(castom_determinant_3) {
  matrix_t A;
  double result;
  castom_create_matrix(1, 1, &A);
  A.matrix[0][0] = 1;
...
START_TEST(castom_determinant_4) {
  matrix_t A;
  double result;
  castom_create_matrix(2, 2, &A);
  A.matrix[0][0] = 55.5;
...
START_TEST(castom_determinant_5) {
  matrix_t A;
  double result;
  castom_create_matrix(4, 4, &A);
  A.matrix[0][0] = 11.1;
...
START_TEST(castom_determinant_6) {
  matrix_t A;
  double result;
  castom_create_matrix(4, 4, &A);
  int check = castom_determinant(&A, &result);
...
START_TEST(castom_determinant_7) {
  matrix_t A;
  double result;
  castom_create_matrix(5, 4, &A);
  int check = castom_determinant(&A, &result);
...
START_TEST(castom_determinant_8) {
  matrix_t A;
  double result;
  castom_create_matrix(-4, 4, &A);
  int check = castom_determinant(&A, &result);
...
START_TEST(castom_calc_complements_1) {
  matrix_t A, result, res_origin;
  castom_create_matrix(3, 3, &A);
  castom_create_matrix(3, 3, &res_origin);
  A.matrix[0][0] = 1;
  A.matrix[0][1] = 2;
  A.matrix[0][2] = 3;
  A.matrix[1][0] = 0;
  ...
  castom_calc_complements(&A, &result);
  for (int i = 0; i < res_origin.rows; i++) {
    for (int j = 0; j < res_origin.columns; j++) {
      ck_assert_uint_eq(res_origin.matrix[i][j], result.matrix[i][j]);
    }
...
START_TEST(castom_calc_complements_2) {
  matrix_t A, result, res_origin;
  castom_create_matrix(2, 2, &A);
  castom_create_matrix(2, 2, &res_origin);
  A.matrix[0][0] = 2;
...
START_TEST(castom_calc_complements_3) {
  matrix_t A, result, res_origin;
  castom_create_matrix(-2, 2, &A);
  castom_create_matrix(2, 2, &res_origin);
  int check = castom_calc_complements(&A, &result);
  int check_origin = 1;
  ck_assert_uint_eq(check, check_origin);
  castom_remove_matrix(&A);
  castom_remove_matrix(&result);
...
START_TEST(castom_calc_complements_4) {
  matrix_t A, result, res_origin;
  castom_create_matrix(2, 4, &A);
  castom_create_matrix(2, 2, &res_origin);
  int check = castom_calc_complements(&A, &result);
  int check_origin = 2;
  ck_assert_uint_eq(check, check_origin);
...
START_TEST(castom_inverse_matrix_1) {
  matrix_t A, result, res_origin;
  castom_create_matrix(3, 3, &A);
  castom_create_matrix(3, 3, &res_origin);
  A.matrix[0][0] = 2;
  ...
  castom_inverse_matrix(&A, &result);
  for (int i = 0; i < res_origin.rows; i++) {
    for (int j = 0; j < res_origin.columns; j++) {
...
START_TEST(castom_inverse_matrix_2) {
  matrix_t A, result, res_origin;
  castom_create_matrix(3, 3, &A);
  castom_create_matrix(3, 3, &res_origin);
  A.matrix[0][0] = 2;
...
START_TEST(castom_inverse_matrix_3) {
  matrix_t A, result, res_origin;
  castom_create_matrix(3, 3, &A);
  castom_create_matrix(3, 3, &res_origin);
  A.matrix[0][0] = 2.8;
...
START_TEST(castom_inverse_matrix_4) {
  matrix_t A, result, res_origin;
  castom_create_matrix(1, 1, &A);
  castom_create_matrix(1, 1, &res_origin);
  A.matrix[0][0] = 777;
  res_origin.matrix[0][0] = 1.0 / 777.0;
  int check = castom_inverse_matrix(&A, &result);
  int check_origin = 0;
...
START_TEST(castom_inverse_matrix_5) {
  matrix_t A, result;
  castom_create_matrix(-5, 5, &A);
  int check = castom_inverse_matrix(&A, &result);
  int check_origin = 1;
...
START_TEST(castom_inverse_matrix_6) {
  matrix_t A, result;
  castom_create_matrix(1, 2, &A);
  A.matrix[0][0] = 777;
  A.matrix[0][1] = 777;
...
START_TEST(castom_inverse_matrix_7) {
  matrix_t A, result;
  castom_create_matrix(3, 3, &A);
  A.matrix[0][0] = 0;
  A.matrix[0][1] = 0;
...
START_TEST(castom_remove_matrix_1) {
  matrix_t A;
  castom_create_matrix(3, 3, &A);
...
int main(void) {
  ...
  tcase_add_test(tc1_1, castom_eq_matrix_1);
  tcase_add_test(tc1_1, castom_eq_matrix_2);
  tcase_add_test(tc1_1, castom_eq_matrix_3);
  tcase_add_test(tc1_1, castom_eq_matrix_4);
  tcase_add_test(tc1_1, castom_eq_matrix_6);
  tcase_add_test(tc1_1, castom_eq_matrix_7);
  tcase_add_test(tc1_1, sum_1);
  tcase_add_test(tc1_1, sum_2);
  tcase_add_test(tc1_1, sum_3);
  tcase_add_test(tc1_1, castom_sum_matrix_1);
  tcase_add_test(tc1_1, castom_sum_matrix_2);
  tcase_add_test(tc1_1, castom_sum_matrix_3);
  tcase_add_test(tc1_1, castom_sum_matrix_4);
  tcase_add_test(tc1_1, castom_sum_matrix_5);
  tcase_add_test(tc1_1, castom_sum_matrix_7);
  tcase_add_test(tc1_1, castom_sum_matrix_8);
  tcase_add_test(tc1_1, castom_sum_matrix_9);
  tcase_add_test(tc1_1, sub_1);
  tcase_add_test(tc1_1, sub_2);
  tcase_add_test(tc1_1, sub_3);
  tcase_add_test(tc1_1, sub_4);
  tcase_add_test(tc1_1, castom_sub_matrix_1);
  tcase_add_test(tc1_1, castom_sub_matrix_2);
  tcase_add_test(tc1_1, castom_sub_matrix_3);
  tcase_add_test(tc1_1, castom_sub_matrix_9);
  tcase_add_test(tc1_1, castom_sub_matrix_10);
  tcase_add_test(tc1_1, castom_sub_matrix_4);
  tcase_add_test(tc1_1, castom_sub_matrix_5);
  tcase_add_test(tc1_1, castom_sub_matrix_7);
  tcase_add_test(tc1_1, castom_sub_matrix_8);
  tcase_add_test(tc1_1, mul_num_1);
  tcase_add_test(tc1_1, mul_num_2);
  tcase_add_test(tc1_1, mul_num_3);
  tcase_add_test(tc1_1, castom_mult_number_1);
  tcase_add_test(tc1_1, castom_mult_number_2);
  tcase_add_test(tc1_1, castom_mult_number_3);
  tcase_add_test(tc1_1, transpose_1);
  tcase_add_test(tc1_1, transpose_2);
  tcase_add_test(tc1_1, transpose_3);
  tcase_add_test(tc1_1, castom_transpose_4);
  tcase_add_test(tc1_1, castom_transpose_5);
  tcase_add_test(tc1_1, castom_transpose_6);
  tcase_add_test(tc1_1, castom_mult_matrix_1);
  tcase_add_test(tc1_1, castom_mult_matrix_2);
  tcase_add_test(tc1_1, castom_mult_matrix_3);
  tcase_add_test(tc1_1, castom_mult_matrix_4);
  tcase_add_test(tc1_1, castom_mult_matrix_5);
  tcase_add_test(tc1_1, castom_mult_matrix_6);
  tcase_add_test(tc1_1, castom_determinant_1);
  tcase_add_test(tc1_1, castom_determinant_2);
  tcase_add_test(tc1_1, castom_determinant_3);
  tcase_add_test(tc1_1, castom_determinant_4);
  tcase_add_test(tc1_1, castom_determinant_5);
  tcase_add_test(tc1_1, castom_determinant_6);
  tcase_add_test(tc1_1, castom_determinant_7);
  tcase_add_test(tc1_1, castom_determinant_8);
  tcase_add_test(tc1_1, castom_calc_complements_1);
  tcase_add_test(tc1_1, castom_calc_complements_2);
  tcase_add_test(tc1_1, castom_calc_complements_3);
  tcase_add_test(tc1_1, castom_calc_complements_4);
  tcase_add_test(tc1_1, castom_inverse_matrix_1);
  tcase_add_test(tc1_1, castom_inverse_matrix_2);
  tcase_add_test(tc1_1, castom_inverse_matrix_3);
  tcase_add_test(tc1_1, castom_inverse_matrix_4);
  tcase_add_test(tc1_1, castom_inverse_matrix_5);
  tcase_add_test(tc1_1, castom_inverse_matrix_6);
  tcase_add_test(tc1_1, castom_inverse_matrix_7);
  tcase_add_test(tc1_1, castom_remove_matrix_1);
